    ...
    return (
        <section id="landing" className="avatar-container">
            ...
            <div className="about-text-container">
                ...
                <p className="section-text">I&apos;m particularly interested in Cloud Engineering and recently a Software Engineering Intern at Scout Motors where I&apos;m working on their Platform team.</p>
